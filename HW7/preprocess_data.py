...
## List of all positive/negative/unlabled data
...
## Create one list of all text files, each file split into tokens (words)
count = 0
x_train = []
...
## List of all positive/negative data files
